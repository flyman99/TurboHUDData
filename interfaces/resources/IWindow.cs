...
namespace Turbo.Plugins
{
    public interface IWindow
    {
        ...
        float InGameClickMinX { get; }
        float InGameClickMaxX { get; }
        float InGameClickMinY { get; }
        float InGameClickMaxY { get; }
        bool CursorInsideGroundRect();
        bool CursorInsideGameWindow();
    }
}